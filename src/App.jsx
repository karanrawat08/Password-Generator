...
function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-800 bg-opacity-75">
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 bg-gray-800 text-orange-500">
        ...
        <div className="text-center mt-4">
          <button
            ...
            className='outline-none bg-green-600 text-white px-4 py-1 rounded-full'
          >
            Generate Password
          </button>
        </div>
